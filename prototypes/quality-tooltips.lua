...
data.raw["storage-tank"]["mine_entrance"].localised_description = {"entity-description.mine_entrance-quality"}
...
add_quality_factoriopedia_info(data.raw["storage-tank"]["mine_entrance"], {
    {{"quality-tooltip.connections"}, function(entity, quality_level)
        local connection_count
        if quality_level <= 0 then
            connection_count = 16
